            ...
            BotConfig(
                ...
                greeting_text=os.getenv(
                    ...
                    (
                        ...
                        "— отношения, чувства, работа, переезд — всё, что важно именно для тебя;\n"
                        "— любые детали, переживания и мысли, которыми захочешь поделиться.\n\n"
                        "Чем честнее и подробнее ты опишешь свой запрос, тем точнее получится расклад — так я смогу лучше понять контекст и задать картам правильные вопросы.\n\n"
                        "Как только я получу твоё сообщение, я вернусь к тебе и предложу несколько вариантов раскладов.\n"
